...
#     numerator = torch.matmul(text_features, image_features_T)
#     # [N, M] = [N, D] x [D, M]
#     # [6, 5]

#     denominator1 = torch.norm(text_features, dim=1, keepdim=True) # [N, 1]
#     denominator2 = torch.norm(image_features, dim=1, keepdim=True) # [M, 1]
#     denominator2 = denominator2.transpose(0,1) # [1, M]
#     denominator = torch.matmul(denominator1, denominator2) # [N, M]

#     similarity = numerator / denominator # [N, M]
...
#     # IDENTIFY BEST MATCH
#     pred_indices = torch.argmax(similarity, dim=0)
